...
public class LoginArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private String findAccessToken(NativeWebRequest webRequest) {
        ...
        //NPE 에서 안전보장(Objects.requireNonNull)
        String accessToken = tokenAuthentication.getJwtFromRequest(Objects.requireNonNull(webRequest.getNativeRequest(HttpServletRequest.class)));
    ...
    private User findAccessAndRefreshToken(String accessToken, String refreshToken) {
        if (tokenProvider.validateAccessToken(accessToken, refreshToken) && tokenProvider.validateRefreshToken(refreshToken)) {
